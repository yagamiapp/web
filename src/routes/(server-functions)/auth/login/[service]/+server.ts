import { PUBLIC_DISCORD_CLIENT_ID, PUBLIC_OSU_CLIENT_ID, PUBLIC_TWITCH_CLIENT_ID } from "$env/static/public";
...
export const GET: RequestHandler = async ({ url, params }) => {
  ...
  const redirectUrl = `${service.login_url}?${requestParams.toString()}${service.args ? "&" + service.args : ""}`
